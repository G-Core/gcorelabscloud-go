...
// ToSecurityGroupRuleCreateMap builds a request body from CreateSecurityGroupRuleOpts.
func (opts CreateSecurityGroupRuleOpts) ToSecurityGroupRuleCreateMap() (map[string]interface{}, error) {
